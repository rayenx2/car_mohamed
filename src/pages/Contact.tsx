    ...
    return (
        ...
        lg:flex-row lg:mx-auto lg:max-w-5xl">
            ...
            xl:mr-10'>
                ...
                <form className="text-lg" action="https://formsubmit.co/Iv.exportservice@gmail.com" method="POST">
                    ...
                    <input className='contact__container__form__input contact__container__form__input-contour' type="hidden" name="_next" value="/thanks"></input>
                </form>
            </span>
            ...
            lg:w-5/12 lg:ml-0'>
                ...
                <div className="flex text-center">
                    <img className="relative top-1 h-4 pr-2" src={phoneIcon} alt="WhatsApp" />
                    <span>WhatsApp: +49 176 69495526</span>
                </div>
                <div className="flex text-center">
                    <img className="relative top-1 h-4 pr-2" src={emailIcon} alt="Email" />
                    <span>Email: Iv.exportservice@gmail.com</span>
                </div>
